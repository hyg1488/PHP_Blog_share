                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <h1>Community</h1>
                            ...
                            <span class="subheading"> This is a free space.</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach($articles as $article){ 
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="detail.php?id=<?=$article['id']?>">
                                    <?=substr("$title",0,35);?>
                                    <?php if(strlen("$title")>=35){?>
                                    ...
                                    <?php }  $sql = "SELECT COUNT(*) as count FROM reply WHERE relId = $id and reltypeCode = 'article'";
                                            $rs = mysqli_query($myConn, $sql);
                         ...
                         <hr/>
                         <div style="text-align:right;"><button type="button"  onclick = "location.href = 'write.php' " class="btn btn-secondary" style="border-radius: 30px;">Writing</button></div>
